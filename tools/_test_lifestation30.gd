extends SceneTree
## Boots Level30 headlessly, drops the player's HP, teleports them next to the new Life1
## station, ticks physics, and confirms HP rises back toward MAX_HP -- and stays put when
