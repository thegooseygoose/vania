...
# ---- minimap (fog-of-war) ----
var map_on := false            # minimap visible? starts OFF — toggled ON by the SELECT button (controller) / TAB
...
func _paint_hp(ci: CanvasItem) -> void:
